...
const ContatUs = () => {
    ...
    const handleWhatsAppSubmit = () => {
        ...
        const whatsappUrl = `https://wa.me/918503027210?text=${whatsappMessage}`;
        window.open(whatsappUrl, '_blank');
    };

    return (
        <>
            <div className=" mx-auto bg-white p-4 font-[sans-serif]">
                <div
                    ...
                    <div>
                        ...
                        <form>
                            <div className="space-y-4 mt-8">
                                <input
                                    ...
                                    className="px-2 py-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-primaryColor outline-none"
                                />
                                <input
                                    type="number"
                                    name="phone"
                                ...
                                <textarea
                                    ...
                                    className="px-2 pt-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-primaryColor outline-none">
                                </textarea>
                            </div>
                            ...
                            <button
                                ...
                                className="mt-8 flex items-center justify-center text-sm w-full px-4 py-2.5 bg-primaryColor hover:bg-yellow-500 text-black"
                            >
                        ...
                        <ul className="mt-4 flex flex-wrap justify-center gap-6">
                            <li className="flex items-center text-primaryColor">
                                ...
                                <Link href="mailto: Info@jojobikerental.com" className="text-sm ml-3">
                                    <strong>Info@jojobikerental.com</strong>
                                </Link>
                            </li>
                            <li className="flex items-center text-primaryColor">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
                                ...
                                <Link href="tel: 8503027210" className="text-sm ml-3">
                                    <strong>
                                        +91 8503027210
                                    </strong>
                                </Link>
